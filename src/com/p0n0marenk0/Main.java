...
class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Количество элементов которые больше своего соседа слева: " + showAmountLeftHigherElements(array));
        System.out.println("Количество четных элементов: " + showEvenNumbers(array));
        System.out.println("Количество элементов которые меньше среднего арифметического: " + showNumbersHigherThenAverage(array));
    }
